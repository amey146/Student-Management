...
urlpatterns = [
    ...
    path('download_csv/<str:file_name>/', views.download_csv, name='attendance_download_csv'),
    path('attendance/delete/<str:file_name>/', views.delete_csv, name='attendance_delete_csv'),
]
